...
BASE_DIR = 'D:/Sopikodelig/ImageClassification/image-classification/'
DATA_DIR = 'C:/Users/Gilang/Documents/Sopikodelig/Image_Recognition/'
TRAIN_DIR = os.path.join(DATA_DIR, 'train/train/')
TEST_DIR = os.path.join(DATA_DIR, 'test/test/')
TEST_FILE = os.path.join(DATA_DIR, 'test.csv')
VAL_FILE = os.path.join(BASE_DIR, 'test_proportion.csv')
TRAIN_FILE = os.path.join(BASE_DIR, 'train_proportion.csv')
...
BATCH_SIZE = 16         # How much image will train in a batch
